...
async def handle_new_message(sid, data: dict, *args):
    ...
    if message_body.other_user_public_id:
        other_user = await app_state.user_repo.get_by_public_id(message_body.other_user_public_id)  # TODO Добавить обработку ошибки
        ...
        chat = await app_state.chat_repo.get_by_id(chat_id=message_body.chat_id)  # TODO Добавить обработку ошибки
    else:
